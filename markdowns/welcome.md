...
@[Luke, how many stars are there in these galaxies?]({ "stubs": ["src/main.js","src/myDeps.js"], "command": "node_modules/rollup/bin/rollup --config rollup.config2.js && node readerTwo.js" })
